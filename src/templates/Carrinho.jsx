...
export default function Carrinho(props) {
    ...
    function adicionar(produto){
        ...
        localStorage.setItem("listaCarrinho", JSON.stringify(produto));
    }
        ...
        setAtivaTabela?
            <div style={{
                ...
                <div style={{
                    ...
                    } type='button' onClick={() => {setAtivaTabela(true)}}>
                ...
                <div id='meu-carrinho' style={{
                    ...
                    <p style={{
                        margin: '0px',
                        padding: '0px',
                    }}>{props.qtdCarrinho || ListaCarrinho.length} item</p>
                </div>
            ...
            :
                <div>
                    <table>
                        ...
                        <button onClick={() => {setAtivaTabela(false)}}>Voltar</button>
                    </table>
                </div>
      )
}